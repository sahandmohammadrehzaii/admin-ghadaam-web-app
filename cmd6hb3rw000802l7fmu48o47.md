---
title: "An Environmental Variable is a dynamic-named value stored within the operating system that can be accessed by running processes and programs to cofigure"
